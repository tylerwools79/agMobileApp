a mobile app for a coding project Master contains all the source code and the commit history. Main serves as a quick download for the whole thing and a place for project metadata.
